...
<section class="ty">
  <div>
    <div class="eyebrow" style="margin-bottom:14px">Message received</div>
    <h1>Thank you - we're on it.</h1>
    <p>Your inquiry just landed with our team. We'll call or text you back the same business day. Want to talk sooner? Call us directly:</p>
    <div class="cta-row">
