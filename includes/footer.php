...
<footer>
  <div class="foot-top">
    ...
    <div class="foot-col">
      <h5>Communities</h5>
      <a href="<?php echo $base; ?>communities/sweet-lake">Sweet Lake - Sturgis</a>
      <a href="<?php echo $base; ?>communities/sturgis-commons">Sturgis Commons - Sturgis</a>
      <a href="<?php echo $base; ?>communities/pine-crest">Pine Crest - Plainwell</a>
    </div>
    <div class="foot-col">
      <h5>Call Us</h5>
    ...
    <div class="foot-col">
      ...
      <a href="<?php echo $base; ?>#homes">Available Homes</a>
    </div>
  </div>
