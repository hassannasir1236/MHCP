...
<footer>
  <div class="foot-top">
    ...
    <div class="foot-col">
      <h5>Communities</h5>
      <a href="<?php echo $base; ?>communities/sweet-lake.php">Sweet Lake - Sturgis</a>
      <a href="<?php echo $base; ?>communities/sturgis-commons.php">Sturgis Commons - Sturgis</a>
      <a href="<?php echo $base; ?>communities/pine-crest.php">Pine Crest - Plainwell</a>
    </div>
    <div class="foot-col">
      <h5>Call Us</h5>
    ...
    <div class="foot-col">
      ...
      <a href="<?php echo $base; ?>index.php#homes">Available Homes</a>
    </div>
  </div>
