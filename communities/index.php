...
<section class="hero hero-page hero-video-bg">
  <video class="hero-video" autoplay muted loop playsinline preload="metadata" poster="<?php echo $base; ?>assets/img/hero.jpg" aria-hidden="true">
    <source src="<?php echo $base; ?>assets/videos/Pine-Crest.mp4" type="video/mp4">
  </video>
...
<section class="section" id="communities" style="background:#fff;border-top:1px solid var(--rule);border-bottom:1px solid var(--rule)">
  ...
  <div class="card-grid">
    <div class="card">
      <div class="card-photo" style="background-image:url('<?php echo $base; ?>assets/img/sweet-lake.jpg')"></div>
      <div class="card-body">
        ...
        <a class="btn btn-navy btn-sm" href="sweet-lake">See This Community</a>
      </div>
    </div>
    <div class="card">
      <div class="card-photo" style="background-image:url('<?php echo $base; ?>assets/img/sturgis-commons.jpg')"></div>
      <div class="card-body">
        <div class="card-location">Sturgis, Michigan</div>
        ...
        <a class="btn btn-navy btn-sm" href="sturgis-commons">See This Community</a>
      </div>
    </div>
    <div class="card">
      <div class="card-photo" style="background-image:url('<?php echo $base; ?>assets/img/pine-crest.jpg')"></div>
      <div class="card-body">
        ...
        <a class="btn btn-navy btn-sm" href="pine-crest">See This Community</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="video-grid">
    <article class="video-card">
      <div class="video-frame">
        <video controls preload="metadata" playsinline poster="<?php echo $base; ?>assets/img/sweet-lake.jpg">
          <source src="<?php echo $base; ?>assets/videos/marty-testimonial.mp4" type="video/mp4">
    ...
    <article class="video-card">
      <div class="video-frame">
        <video controls preload="metadata" playsinline poster="<?php echo $base; ?>assets/img/pine-crest.jpg">
          <source src="<?php echo $base; ?>assets/videos/michelle-testimonial.mp4" type="video/mp4">
          Your browser does not support the video tag.
        </video>
      </div>
      <div class="video-body">
...
<div class="cta-band">
  ...
  <div class="cta-row">
    <a class="btn btn-gold" href="<?php echo $base; ?>contact">Contact Us</a>
